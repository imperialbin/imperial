...
name:"Elixir",keywords:i,contains:t}}})());hljs.registerLanguage("plaintext",(()=>{"use strict";return t=>({
...
className:"number",begin:"(&[oO][0-7]{1,6})"}]})})());hljs.registerLanguage("objectivec",(()=>{"use strict";return e=>{
...
},...B,...k,...S,I,K,...z,...q,U,G]}}})());hljs.registerLanguage("less",(()=>{"use strict"
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},r,s]}}})());hljs.registerLanguage("c-like",(()=>{"use strict";function e(e){
...
className:"class",beginKeywords:"enum class struct union",end:/[{;:<>=]/,
contains:[{beginKeywords:"final class struct"},t.TITLE_MODE]}]),exports:{
preprocessor:c,strings:s,keywords:u}}}})());hljs.registerLanguage("dart",(()=>{"use strict";return e=>{const n={
...
contains:[{beginKeywords:"extends implements"},e.UNDERSCORE_TITLE_MODE]
},e.C_NUMBER_MODE,{className:"meta",begin:"@[A-Za-z]+"},{begin:"=>"}]}}})());hljs.registerLanguage("kotlin",(()=>{"use strict"
;var e="\\.([0-9](_*[0-9])*)",n="[0-9a-fA-F](_*[0-9a-fA-F])*",a={
className:"number",variants:[{
begin:`(\\b([0-9](_*[0-9])*)((${e})|\\.)?|(${e}))[eE][+-]?([0-9](_*[0-9])*)[fFdD]?\\b`
},{begin:`\\b([0-9](_*[0-9])*)((${e})[fFdD]?\\b|\\.([fFdD]\\b)?)`},{
...
end:"$",illegal:"\n"},o]}}})());hljs.registerLanguage("asciidoc",(()=>{"use strict";function e(...e){
return e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null;var n
...
aliases:["yml","YAML"],contains:b}}})());hljs.registerLanguage("profile",(()=>{"use strict";return e=>({
...
end:"\\)$",excludeBegin:!0,excludeEnd:!0,relevance:0}]})})());hljs.registerLanguage("gradle",(()=>{"use strict";return e=>({name:"Gradle",
