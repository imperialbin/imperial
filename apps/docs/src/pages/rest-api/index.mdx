...
| Code             | Description                                                      |
| ---------------- | ---------------------------------------------------------------- |
| `unauthorized`   | User is not authorized the route requires it.                    |
| `bad_auth`       | User is authorized, but has no access to the requested material. |
| `not_found`      | The requested material was not found.                            |
| `bad_request`    | The request was malformed in some way                            |
